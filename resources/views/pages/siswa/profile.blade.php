...
@section('main')
    <section class="section">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('siswa.update.profile') }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="id" value="{{ old('nama_siswa', Auth::user()->id) }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select id="jenis_kelamin" type="text" class="form-control" name="jenis_kelamin"
                                    required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select id="pendidikan_ayah" type="text" class="form-control" name="pendidikan_ayah"
                                    required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="pendidikan_ibu">Pendidikan Terakhir Ibu<span
                                        class="text-danger">*</span></label>
                                <select id="pendidikan_ibu" type="text" class="form-control" name="pendidikan_ibu"
                                    required>
                                    <option value="Sekolah Dasar"
