...
@section('title', 'Detail Data Presensi Siswa')
...
<section class="section">
    <div class="section-header">
        <h1>Detail Data Presensi Siswa</h1>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <h5>Kelas: <span class="text-primary">{{ $kartuStudi->first()->kelas->nama_kelas ?? '' }} </span> | Ruang <span class="text-primary">{{ $kartuStudi->first()->kelas->ruang ?? '' }} </span></h5>
                    ...
                    <table class="table mt-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->presensi ? $data->presensi->status : '-' }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
